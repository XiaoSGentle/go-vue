...
func newSysDepartment(db *gorm.DB, opts ...gen.DOOption) sysDepartment {
	...
	_sysDepartment.ID = field.NewInt32(tableName, "id")
	_sysDepartment.Name = field.NewString(tableName, "name")
	_sysDepartment.ParentID = field.NewInt32(tableName, "parent_id")
	_sysDepartment.CreateBy = field.NewString(tableName, "create_by")
	_sysDepartment.CreateTime = field.NewTime(tableName, "create_time")
	_sysDepartment.CreateUID = field.NewInt32(tableName, "create_uid")
...
func (s sysDepartment) Columns(cols ...field.Expr) gen.Columns {
	return s.sysDepartmentDo.Columns(cols...)
}
