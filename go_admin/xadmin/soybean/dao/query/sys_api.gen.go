...
func newSysAPI(db *gorm.DB, opts ...gen.DOOption) sysAPI {
	...
	_sysAPI.CreateBy = field.NewString(tableName, "create_by")
	_sysAPI.CreateTime = field.NewTime(tableName, "create_time")
	_sysAPI.UpdateBy = field.NewString(tableName, "update_by")
