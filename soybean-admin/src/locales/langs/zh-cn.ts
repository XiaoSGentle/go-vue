const local: App.I18n.Schema = {
    ...
    route: {
        ...
        projects_document: "文档管理",
        projects_document_api: "Api文档",
        projects_document_files: "文件网盘",
        projects_document_knowledge: "知识管理",
        projects_test: "测试管理",
        projects_repository: "代码仓库",
        projects_synergy: "项目协同",
        projects_document_wiki: "Wiki",
        projects_test_overview: "测试概览",
        projects_test_plan: "测试计划",
        projects_test_report: "测试报告",
        "projects_test_use-case": "测试用例",
