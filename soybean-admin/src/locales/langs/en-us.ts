const local: App.I18n.Schema = {
    ...
    route: {
        ...
        projects_document_api: "Api Document",
        projects_document_files: "Cloud File",
        projects_document_knowledge: "Knowledge",
        projects_test: "Test Management",
        projects_repository: "Code Repository",
        projects_synergy: "Synergy",
        projects_document_wiki: "Wiki",
        projects_test_overview: "Overview",
        projects_test_plan: "Test Plan",
        projects_test_report: "Report",
        "projects_test_use-case": "Use Case",
    },
    page: {
        login: {
            common: {
