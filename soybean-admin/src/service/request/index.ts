...
export const request = createFlatRequest<App.Service.Response, InstanceState>(
  ...
  },
  {
    ...
    async onBackendFail(response, instance) {
      ...
      if (logoutCodes.includes(response.data.code.toString())) {
        handleLogout();
        return null;
      }
      ...
      if (modalLogoutCodes.includes(response.data.code.toString())) {
      ...
      if (expiredTokenCodes.includes(response.data.code.toString()) && !request.state.isRefreshingToken) {
